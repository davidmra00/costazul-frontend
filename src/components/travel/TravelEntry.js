    ...
    <>
      <div className="u-container-style u-list-item u-repeater-item u-list-item-5 col">
        <div className="u-container-layout u-similar-container u-container-layout-9">
          ...
          <Link to={`/viajes/${slug}`} className="u-border-none u-btn u-btn-round u-button-style u-custom-color-2 u-hover-palette-4-dark-1 u-radius-6 u-btn-1">SABER MÁS</Link>
        </div>
      </div>
