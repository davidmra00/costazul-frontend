  ...
  return (
    <>
      <section className="u-clearfix u-white u-section-2" id="carousel_302f">
        ...
        <div className="u-clearfix u-sheet u-valign-middle-md u-valign-middle-sm u-sheet-1">
          ...
          <div className="u-container-style u-expanded-width-sm u-expanded-width-xs u-group u-radius-5 u-shape-round u-white u-group-1">
            <div className="u-container-layout u-valign-top-lg u-valign-top-md u-valign-top-xl u-container-layout-1">
              ...
              <p className="u-custom-font u-text u-text-custom-color-2 u-text-2">Te ofrecemos </p>
              <p className="u-custom-font u-text u-text-3"> las mejores opciones para que disfrutes tus vacaciones, también podemos entregar tus paquetes de forma segura y enviar remesas con la mayor confiabilidad.</p>
            </div>
          </div>
          <div className="u-expanded-width-lg u-expanded-width-md u-expanded-width-sm u-expanded-width-xl u-list u-list-1">
            <div className="u-repeater u-repeater-1">
              <div className="u-align-center u-container-style u-list-item u-repeater-item">
                <div className="u-container-layout u-similar-container u-valign-top-xs u-container-layout-2"><span className="u-icon u-text-custom-color-2 u-icon-1"><svg className="u-svg-link" preserveAspectRatio="xMidYMin slice" viewBox="0 0 52 52"><use xmlnsXlink="http://www.w3.org/1999/xlink" xlinkHref="#svg-69e0"></use></svg><svg className="u-svg-content" viewBox="0 0 52 52" x="0px" y="0px" id="svg-69e0" style={{enableBackground:"new 0 0 52 52"}}><g><path d="M26,0C11.664,0,0,11.663,0,26s11.664,26,26,26s26-11.663,26-26S40.336,0,26,0z M40.495,17.329l-16,18
		...
		C41.154,15.239,41.229,16.503,40.495,17.329z"></path>
                  ...
                  <p className="u-custom-font u-text u-text-default u-text-4">EFICAZ</p>
                </div>
              </div>
              <div className="u-align-center u-container-style u-list-item u-repeater-item">
                <div className="u-container-layout u-similar-container u-valign-top-xs u-container-layout-3"><span className="u-icon u-text-custom-color-2 u-icon-2"><svg className="u-svg-link" preserveAspectRatio="xMidYMin slice" viewBox="0 0 60 60"><use xmlnsXlink="http://www.w3.org/1999/xlink" xlinkHref="#svg-fb17"></use></svg><svg className="u-svg-content" viewBox="0 0 60 60" x="0px" y="0px" id="svg-fb17" style={{enableBackground:"new 0 0 60 60"}}><g><path d="M34.74,36.53l9.363-12.944c0.287-0.397,0.244-0.945-0.104-1.293c-0.348-0.346-0.896-0.39-1.293-0.104L29.76,31.555
		...
		c0.012-0.021,0.011-0.043,0.021-0.064C56.817,42.476,58.13,37.89,58.13,33S56.817,23.524,54.534,19.564z"></path><path d="M22.293,13h-5c-1.104,0-2,0.896-2,2s0.896,2,2,2h5c1.104,0,2-0.896,2-2S23.397,13,22.293,13z"></path><path d="M22.293,20h-10c-1.104,0-2,0.896-2,2s0.896,2,2,2h10c1.104,0,2-0.896,2-2S23.397,20,22.293,20z"></path><path d="M22.293,27h-15c-1.104,0-2,0.896-2,2s0.896,2,2,2h15c1.104,0,2-0.896,2-2S23.397,27,22.293,27z"></path><path d="M22.293,34h-19c-1.104,0-2,0.896-2,2s0.896,2,2,2h19c1.104,0,2-0.896,2-2S23.397,34,22.293,34z"></path><path d="M22.293,41h-13c-1.104,0-2,0.896-2,2s0.896,2,2,2h13c1.104,0,2-0.896,2-2S23.397,41,22.293,41z"></path><path d="M22.293,48h-7c-1.104,0-2,0.896-2,2s0.896,2,2,2h7c1.104,0,2-0.896,2-2S23.397,48,22.293,48z"></path>
                  ...
                  <p className="u-custom-font u-text u-text-default u-text-5">RÁPIDO</p>
                </div>
              </div>
              <div className="u-align-center u-container-style u-list-item u-repeater-item">
                <div className="u-container-layout u-similar-container u-valign-top-xs u-container-layout-4"><span className="u-icon u-text-custom-color-2 u-icon-3"><svg className="u-svg-link" preserveAspectRatio="xMidYMin slice" viewBox="0 0 60 60"><use xmlnsXlink="http://www.w3.org/1999/xlink" xlinkHref="#svg-240d"></use></svg><svg className="u-svg-content" viewBox="0 0 60 60" x="0px" y="0px" id="svg-240d" style={{enableBackground:"new 0 0 60 60"}}><path d="M38.914,0H6.5v60h47V14.586L38.914,0z M24.125,41.781l-5,4C18.941,45.928,18.72,46,18.5,46
	...
	c0.552,0,1,0.447,1,1S43.052,34,42.5,34z M42.5,23h-16c-0.552,0-1-0.447-1-1s0.448-1,1-1h16c0.552,0,1,0.447,1,1S43.052,23,42.5,23z
	 M37.5,16V2l14,14H37.5z"></path></svg></span>
                  <p className="u-custom-font u-text u-text-default u-text-6">MEJOR</p>
                </div>
              </div>
            </div>
          </div>
